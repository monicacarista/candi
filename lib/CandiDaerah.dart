...
// "    SELECT ?id ?candi  ?data ?jenis ?data"+
...
//     "(GROUP_CONCAT(COALESCE(?lokasii,''); separator = ',' )as ?lokasi)"+
...
//     "WHERE{"+
//     "?id dbo:location ?lokasii."+
//     "?id :lokasiDari	?candi1."+
//     "?candi1	rdfs:label	?candi."+
//          "   :CandiNonKeagamaan rdfs:label ?jenis." +
//          "?id :sumberDB	?data."+
//     "OPTIONAL {?id :sumberDB ?data}"+
//     "OPTIONAL{?id :Deskripsi ?desc.}"+
//     "OPTIONAL {?candi1 :Gambar1 ?gmbr}"+
...
//     "OPTIONAL {?id1 :namaLainDari ?ida."+
//     "?ida rdfs:label ?nama}}"+
//     "GROUP BY ?id ?candi ?nama ?lokasii ?data ?gmbr ?mapp ?arcas ?bahann ?jenis ?data");
//
