...
class CandiSiwaBuddha extends StatefulWidget {
  @override
  _CandiSiwaBuddha createState() => _CandiSiwaBuddha();
}
  ...
  Future<List<Tripleset>> mainSiwa() async {
    var payload = Uri.encodeComponent(
        "prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>"+
            ...
            "WHERE {"+
            " ?id rdf:type :CandiSiwaBuddha ."+
            "   :CandiSiwaBuddha rdfs:label ?jeniss."+
            "?id :sumberDB	?dataa."+
            " ?id rdfs:label ?candi."+
