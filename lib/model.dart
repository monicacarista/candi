...
class Tripleset {
  ...
  final TypeValue terdiridari;
  final TypeValue bagiandari;
  ...
  factory Tripleset.fromJson(Map json) {
    return Tripleset(
      ...
      TypeValue.fromJson(json['terdiridari']),
      TypeValue.fromJson(json['bagiandari']),
      ...
      TypeValue.fromJson(json['sumber']),
    );
  }
